...
export function LoginScreen({ onAuthed }: { onAuthed: () => void }) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.brand}>{APP_NAME} Rider</Text>
      <Text style={styles.tagline}>Flexible local deliveries. Transparent earnings.</Text>
...
const styles = StyleSheet.create({
  ...
  brand: { fontSize: 34, color: theme.colors.brandDeep, fontWeight: "800" },
  tagline: { color: theme.colors.muted, marginBottom: theme.spacing.lg, marginTop: 8 },
  card: {
